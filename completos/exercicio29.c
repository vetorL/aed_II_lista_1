...
#define HOTEL 9439
#define OUTRO 74893
#define CAMINHOPROIBIDO 3432432
...
int estabelecimentoMaisProximo(vertice * g, int i, int e, int caminhoProibido) {
    ...
    while(f.inicio) {
        ...
        while(p) {
            ...
            if(g[p->adj].flag == 0 && g[p->adj].estabelecimento != caminhoProibido) {
                entrarFila(&f, p->adj);
                g[p->adj].flag = 1;
            }
